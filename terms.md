...
Puedes utilizar la aplicación como invitado o crear una cuenta.

Al crear una cuenta aceptas:

- Proporcionar información veraz y actualizada.
- No crear cuentas falsas ni suplantar la identidad de otras personas.
- Mantener la confidencialidad de tu contraseña.
- Ser responsable de toda la actividad realizada desde tu cuenta.
...
Nos reservamos el derecho de suspender o cancelar cuentas que incumplan estos términos, utilicen la aplicación de forma fraudulenta, afecten su funcionamiento o vulneren los derechos de otros usuarios.

## 5. Uso permitido

Aceptas utilizar la aplicación únicamente con fines educativos y de preparación académica.

Queda prohibido:

- Utilizar la aplicación para actividades ilegales o no autorizadas.
...
- Automatizar consultas mediante bots o herramientas similares.
- Reproducir, distribuir o utilizar el contenido de la aplicación sin autorización.

## 6. Propiedad intelectual

Todo el contenido de la aplicación, incluyendo textos, diseños, logotipos, bases de datos, interfaz gráfica, preguntas desarrolladas por Saber Más y demás elementos protegidos por la legislación aplicable, pertenece a sus respectivos titulares.

Salvo autorización expresa, no está permitido copiar, reproducir, distribuir, modificar o utilizar dicho contenido con fines comerciales.

## 7. Contenido de la aplicación

Los simulacros, preguntas y demás recursos educativos se ofrecen con fines exclusivamente académicos.

Aunque procuramos mantener el contenido actualizado y de calidad, este puede diferir del contenido de las pruebas oficiales y no representa material oficial del ICFES.
...
- El servicio esté disponible de forma ininterrumpida.
- Los simulacros predigan el desempeño del usuario en las Pruebas Saber o ICFES.
- El contenido cubra la totalidad de los temas evaluados en los exámenes oficiales.
